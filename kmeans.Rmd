...
We can use the silhouette statistic and plots to help us pick the cluster solution with the largest overall width. To learn more about [silhouettes](https://www.sciencedirect.com/science/article/pii/0377042787901257?via%3Dihub). Essentially, this measure quantifies how much better the assigned cluster is to the next best one. The value ranges from 0 to 1. 
